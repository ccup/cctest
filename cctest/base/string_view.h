#ifndef HFD5A349C_718B_4752_BC75_8F3D2E19E384
#define HFD5A349C_718B_4752_BC75_8F3D2E19E384
...
struct StringView {
  ...
  std::vector<std::string> split(StringView delims) const;
...
private:
  ...
  std::vector<std::string> safeSplit(StringView delims) const;
